...
# =============================================================================
# Asset Preview Widget (supports models and textures)
# =============================================================================
...
class AssetPreviewWidget(QtWidgets.QWidget):
    ...
    def _draw_texture(self, painter):
        ...
        scale = min(scale_x, scale_y, 4.0)  # Cap at 4x zoom for small textures
